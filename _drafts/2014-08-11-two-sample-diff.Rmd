...
In practice there are many questions. What to do if the sample data is not normally distributed? Should we only care about the differences in the mean, or consider variance as well? There are statistical tests for everything, normality, equality of variance (homoskedasticity), but isn't that multiple testing? And what about statistical power?

I would like to resolve the above doubts through a series of questions.
Can we assume the sample data has Normal distribution? Two sample t-test.
